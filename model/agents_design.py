...
from eval.webshop.web_agent_site.engine.engine import (
    load_products,
    init_search_engine,
...
from eval.webshop.web_agent_site.engine.goal import get_reward, get_goals
...
class WebAgentTextEnv(gym.Env):
    ...
    def reset(self, session=None, instruction_text=None, instruction_idx=None):
        ...
        self.browser.get(init_url, session_id=self.session, session_int=session_int, instruction_idx=instruction_idx)
...
class SimServer:
    ...
    def receive(self, session_id, current_url, session_int=None, instruction_idx=None, **kwargs):
...
class SimBrowser:
    ...
    def get(self, url, session_id=None, session_int=None, instruction_idx=None):
        ...
        self.page_source, _, _ = \
            self.server.receive(self.session_id, self.current_url, session_int=session_int, instruction_idx=instruction_idx)
